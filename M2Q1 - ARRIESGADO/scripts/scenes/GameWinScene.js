class GameWinScene extends Phaser.Scene
{
    ...
    create() 
    {
        ...
        // Text Display for Win Condition
        let gameOverText = this.add.text(600,250, "YOU FOUND A STARDROP!\nYOU WIN!",
        ...
        gameOverText.setShadow(5, 5, '#FFD700', 5, true, true);

        // // Score || ONLY APPEARS ON LOSE CONDITION!
        // let score = this.scene.get('GameScene').data.get('score');

        // // Text Display For Score
        // let detailsText = this.add.text(600, 250, "Score: "+score+" ",
